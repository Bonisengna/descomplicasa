...
const calculators = [
  { title: "Financiamento", text: "Descubra quanto pode financiar e tenha uma noção das parcelas.", Icon: CalculatorIcon },
    ...
    <main id="top">
        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="button" href="#calculadoras">Calcular meus custos <ArrowIcon /></a>
            ...
            <div className="hero-benefits" aria-label="Benefícios">
              ...
              <div><span className="mini-icon"><ShieldIcon /></span><p><strong>Sem cadastro</strong><small>Acesse a Home e conheça o projeto.</small></p></div>
          ...
          <div className="hero-visual" aria-label="Exemplo de resumo de uma compra">
            ...
            <div className="summary-card">
              ...
              <p className="summary-note">Valores apenas ilustrativos. As calculadoras serão adicionadas nas próximas etapas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="about-section" id="sobre">
        <div className="container about-grid">
          ...
          <div><p>O Descomplicasa nasce para reunir ferramentas e conteúdo em uma experiência simples: calcular, conferir e entender antes de decidir.</p><p className="about-disclaimer">O conteúdo terá caráter informativo e não substituirá análise jurídica, registral, bancária ou técnica quando necessária.</p></div>
        </div>
      </section>
      ...
      <section className="final-cta">
        <div className="container final-cta-inner">
          ...
          <a className="button button-light" href="#calculadoras">Conhecer as ferramentas <ArrowIcon /></a>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          ...
          <p>© 2026 Descomplicasa. MVP em desenvolvimento.</p>
        </div>
      </footer>
    </main>
  );
